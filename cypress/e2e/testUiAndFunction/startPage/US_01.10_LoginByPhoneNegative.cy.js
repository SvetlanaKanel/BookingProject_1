...
describe('US_01.10 | Login by phone negative', { tags: ['regression'] }, () => {
    ...
    it('AT_01.10.06 | Verify that registering is not possible with any symbols "Phone number" input', function() {
        loginPopup.enterCountryCode(this.startPage.data.phoneNumber.code);
        loginPopup.enterPhoneNumber(this.startPage.dataInvalid.symbolsInPhoneNumber);
        loginPopup.clickRequestCodeButton();

class BookingPopup {
    ...
    getFirstPassengerTypeLabel = () => cy.get('.passengers-box > :nth-child(1) > :nth-child(1) > label')
    getSecondPassengerTypeLabel = () => cy.get('.passengers-box > :nth-child(2) > :nth-child(1) > label')
